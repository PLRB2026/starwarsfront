...
const CargarPersonajes = async (url) => {
    ...
    const personajes = await PersonajeResponse.json();

    const personajesLimitados = personajes.slice(0, 10);

    characterListDiv.innerHTML = '';
    personajesLimitados.forEach((personaje) => {
...
CargarPersonajes('https://swapi.info/api/people/');